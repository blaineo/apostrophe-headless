...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.findForRestApi = function(req, childDepth) {
      ...
      var cursor = childDepth 
        ? self.find(req).ancestors(true).children({depth: Number(childDepth)}).published(null) 
        : self.find(req, {}, { title: 1, slug: 1, path: 1, type: 1, body: 1 }).ancestors({       
          children: {
            depth: 2,
            projection: {
              title: 1,
            ...
            areas: [ 'pageThumbnails' ]
          }, projection: {
            title: 1,
            slug: 1,
            path: 1,
            type: 1
          }}).children(true).published(null);
